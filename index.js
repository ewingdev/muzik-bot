...
client.deploySlash = {
  enabled: true,
  guild: false, // false |"ID" (yanlışsa, sadece bir kez küresel ayarlayın ve sonra bir daha asla ihtiyaç duymadı!) & false | "ID" (if it's false, just set global once, and then never needed again!)
}
// Global config file
